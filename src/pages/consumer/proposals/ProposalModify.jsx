    ...
    <>
      ...
      <div style={styles.pageWrapper}>
        <div style={styles.container}>
          <Form>
            <FormGroup>
              <Label className="fw-bold text-end d-block"><img src="/left.png" alt="뒤로가기" className="back" style={{width:'20px', height:'20px',  marginRight:"5px"}}/>뒤로가기</Label>
            </FormGroup>
            {/* 이름 */}
              ...
              <div style={styles.bigUploadBox}>
                <div style={styles.imageGrid}>
                  ...
                  <div style={styles.imageBox}>
                    ...
                    {/* <Input type="file" accept='image/*' hidden innerRef={fileRef} 
