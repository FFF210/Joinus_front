        ...
        <div style={styles.container}>
          ...
          {!loading && visibleOrderList.map((order, index) => (
            <div key={order.orderItemId || index} style={{ ...styles.row, borderBottom: "1px solid #eee" }}>
              ...
              {/* 상품 정보 */}
              <div style={{ ...styles.col, width: "43%", display: "flex", alignItems: "center" }}>
                <img
              ...
              {/* 버튼 영역 */}
              <div style={{ ...styles.col, width: "10%", display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '2px' }}>
                <div style={{
                  padding: "4px 10px",
                  borderRadius: "6px",
                  fontSize: "13px",
